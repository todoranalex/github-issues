...
export const Input: FunctionComponent<{
  ...
  return (
    <View>
      <Text style={{ color: theme.colors.primary, ...styles.textInputInfo }}>{label}</Text>
      <TextInput
        testID={testID}
  ...
  return (
    ...
    >
      <View style={styles.buttonInnerContainer}>
        <Text style={{ ...styles.buttonText, color: theme.colors.primary }}>{text}</Text>
        {icon && <GithubIcon name={icon} size={24} color={theme.colors.primary} />}
      </View>
    </TouchableOpacity>
  )
}
...
export const NavigationHeaderItem: FunctionComponent<{
  ...
  return (
    <View style={styles.navHeaderContainer}>
      <GithubIcon onPress={onPress} name={'arrow-left'} color={'white'} size={24} />
